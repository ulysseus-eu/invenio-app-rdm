...
def create_ui_blueprint(app):
    ...
    blueprint.add_url_rule(
        **create_url_rule(routes["person-detail"], persons_detail),
        strict_slashes=False,
    )

    blueprint.add_url_rule(
        **create_url_rule(routes["organization-detail"], organizations_detail),
        strict_slashes=False,
    )
    ...
    blueprint.add_url_rule(
        **create_url_rule(routes["person-home"], persons_home)
    )

    blueprint.add_url_rule(
        **create_url_rule(routes["organization-home"], organizations_home)
    )
